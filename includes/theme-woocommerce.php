...
function woocommerce_prettyphoto() {
	global $woo_options;
	if ( isset( $woo_options['woo_enable_lightbox'] ) && 'true' == $woo_options['woo_enable_lightbox'] ) {
...
if ( ! function_exists( 'woocommerce_get_sidebar' ) ) {
	function woocommerce_get_sidebar() {
		...
		if ( isset( $woo_options['woocommerce_archives_fullwidth'] ) && ( 'true' == $woo_options['woocommerce_archives_fullwidth'] ) && ( is_archive( array( 'product' ) ) ) ) :
			get_sidebar( 'shop' );
		endif;

		// Display the sidebar if full width option is disabled on product pages
		if ( isset( $woo_options['woocommerce_products_fullwidth'] ) &&  ( 'true' == $woo_options['woocommerce_products_fullwidth'] ) && ( is_singular( array( 'product' ) ) ) ) :
			get_sidebar( 'shop' );
		endif;
...
if ( ! function_exists( 'wooframework_layout_body_class' ) ) {
	function wooframework_layout_body_class( $wc_classes ) {
		...
		if ( isset( $woo_options['woocommerce_archives_fullwidth'] ) && ( 'false' == $woo_options['woocommerce_archives_fullwidth'] ) && ( is_shop() || is_product_category() ) ) {
			$layout = 'layout-full';
		}

		if ( isset( $woo_options['woocommerce_products_fullwidth'] ) &&  ( 'false' == $woo_options['woocommerce_products_fullwidth'] ) && is_product() ) {
			$layout = 'layout-full';
		}

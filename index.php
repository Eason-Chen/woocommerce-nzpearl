    ...
    <div id="content" class="col-full <?php if ( $woo_options[ 'woo_homepage_banner' ] == "true" ) echo 'with-banner'; ?> <?php if ( $woo_options[ 'woo_homepage_sidebar' ] == "false" ) echo 'no-sidebar'; ?>">
		...
		<div class="woocommerce columns-4">
			<ul style="list-style:none; margin:0; padding:0;">
				<li style="float:left; width:23.5%; margin-right:2%;">
					<a href="http://newzealandpearl.co.nz/product-category/tahitian/">
					<?php
						$id=23980;
						$post = get_post($id);
						the_post_thumbnail();
					...
					<p style="text-align:center; font-weight: bold;">Tahitian</p>
				</li>
				<li style="float:left; width:23.5%; margin-right:2%;">
					<a href="http://newzealandpearl.co.nz/product-category/golden-south-sea/">
					<?php
						$id=23982;
						$post = get_post($id);
						the_post_thumbnail();
					...
					<p style="text-align:center; font-weight: bold;">Golden South Sea</p>
				</li>
				<li style="float:left; width:23.5%; margin-right:2%;">
					<a href="http://newzealandpearl.co.nz/product-category/white-south-sea/">
					<?php
						$id=23984;
						$post = get_post($id);
						the_post_thumbnail();
					...
					<p style="text-align:center; font-weight: bold;">White South Sea</p>
				</li>
				<li style="float:left; width:23.5%;">
					<a href="http://newzealandpearl.co.nz/product-category/freshwater/">
					<?php
						$id=23986;
						$post = get_post($id);
						the_post_thumbnail();
					...
					<p style="text-align:center; font-weight: bold;">Freshwater</p>
				</li>
			</ul>
		</div>
